...
exports.dis = function _8051dis(b, i) {
    ...
    switch(((b[i] | ((b[i+1] << 8) & 0xffff)) & 0xffff) & 0x80f7) {
        ...
        case 0x95: return [2, new Mov(($0 = R1[0]), new u8(($2 = ($1 = R8[96]).add(new Mem8(new i8(new u8(b[i+1] & 127))).neg()))).lt(new u8($0))), new Mov($1, $2.add(new i8($0).neg()))];
        ...
        case 0x8095: return [2, new Mov(($0 = R1[0]), new u8(($2 = ($1 = R8[96]).add(R8[((((b[i+1] & 127) & 0xff)) & 0xff)].neg()))).lt(new u8($0))), new Mov($1, $2.add(new i8($0).neg()))];
    ...
    switch(b[i] & 0xf7) {
        ...
        case 0x94: return [2, new Mov(($0 = R1[0]), new u8(($2 = ($1 = R8[96]).add(new i8(-((b[i+1]) << 24 >> 24))))).lt(new u8($0))), new Mov($1, $2.add(new i8($0).neg()))];
        case 0x96: return [1, new Mov(($0 = R1[0]), new u8(($2 = ($1 = R8[96]).add(new Mem8(new Mem8(new i8(0))).neg()))).lt(new u8($0))), new Mov($1, $2.add(new i8($0).neg()))];
        case 0x97: return [1, new Mov(($0 = R1[0]), new u8(($2 = ($1 = R8[96]).add(new Mem8(new Mem8(new i8(1))).neg()))).lt(new u8($0))), new Mov($1, $2.add(new i8($0).neg()))];
    ...
    switch(((((b[i] & 240) & 0xff) >>> 4) & 0xff) & 0xf) {
        ...
        case 0x9: return [1, new Mov(($0 = R1[0]), new u8(($2 = ($1 = R8[96]).add(new Mem8(new i8(new u8(b[i] & 7))).neg()))).lt(new u8($0))), new Mov($1, $2.add(new i8($0).neg()))];
        case 0xb: return [3, new If(new Mem8(new i8(new u8(b[i] & 7))).eq(new i8(new u8(b[i+1]))).not(), new Mov(($0 = R32[0]), $0.add(new i8(((b[i+2]) << 24 >> 24) + 3))))];
        case 0xc: return [1, new Mov(($2 = (new Register8)), ($0 = new Mem8(new i8(new u8(b[i] & 7))))), new Mov($0, ($1 = R8[96])), new Mov($1, $2)];
        case 0xd: return [2, new Mov(($0 = new Mem8(new i8(new u8(b[i] & 7)))), $0.add(new i8(-1))), new If($0.eq(new i8(0)).not(), new Mov(($1 = R32[0]), $1.add(new i8(((b[i+1]) << 24 >> 24) + 2))))];
